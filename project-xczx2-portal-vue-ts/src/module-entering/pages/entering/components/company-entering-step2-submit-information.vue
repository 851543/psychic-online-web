    ...
    <el-form ref="form2" :model="form" :rules="rules" class="form" label-width="200px">
      ...
      <el-form-item label="机构简介：" prop="intro">
        <el-input
          ...
          :rows="10"
          v-model="form.intro"
          placeholder="例：通灵在线，目前已经成为拥有2000多名员工的教育集团；从成立最初的单一Java学科，到现在已包括JavaEE、Python+人工智能、前端与移动开发、UI/UE设计、大数据、Go语言与区块链等14门学科培训；从屈指可数的几间教室，发展成为分布于北京、上海、广州、深圳、武汉、郑州、西安、长沙、济南、重庆、南京、杭州、成都、石家庄、合肥、太原、厦门、沈阳等18所城市直营中心的规模。"
          maxlength="500"
          show-word-limit
        ></el-input>
      </el-form-item>
